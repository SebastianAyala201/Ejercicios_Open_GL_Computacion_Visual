// Algoritmo DDA en el segundo cuadrante
...
// Función para dibujar una línea dda en el segundo cuadrante
...
int main(int argc, char *argv[]){
    ...
    glutCreateWindow("Algoritmo DDA en el segundo cuadrante"); // Crea una ventana con el título especificado
    inicio(); 
