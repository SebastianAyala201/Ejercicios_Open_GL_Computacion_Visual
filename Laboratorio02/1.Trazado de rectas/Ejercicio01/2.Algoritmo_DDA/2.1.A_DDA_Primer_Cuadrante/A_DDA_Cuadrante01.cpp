// Algoritmo DDA en el primer cuadrante
...
// Función para dibujar una línea dda en el primer cuadrante
...
int main(int argc, char *argv[]){
    ...
    glutCreateWindow("Algoritmo DDA en el primer cuadrante"); // Crea una ventana con el título especificado
    inicio(); 
