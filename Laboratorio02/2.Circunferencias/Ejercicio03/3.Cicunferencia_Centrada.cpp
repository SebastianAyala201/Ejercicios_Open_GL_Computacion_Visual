// Algoritmo del Punto Medio para Circunferencia
...
// Variables globales para almacenar los parametros de la circunferencia
int radio;
...
void pantalla() {
    ...
    // Dibuja la circunferencia con los parametros dados
